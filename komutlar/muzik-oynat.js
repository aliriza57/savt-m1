...
exports.run = async (client, message, args) => {
    ...
    .setColor("e2284e")
    .setDescription(`:red_square:  | **Lütfen bir sesli kanala katılınız.**`)
    ...
    if (!permissions.has('CONNECT')) {
      ...
      .setColor("e2284e")
      .setDescription(`:red_square:  **| Herhangi bir sesli kanala katılabilmek için yeterli iznim yok.**`)
    ...
    if (!permissions.has('SPEAK')) {
      ...
      try {
          ...
          .setColor("RED")
          .setDescription(`:red_square:  | Aradığınız isimde bir şarkı bulunamadı!`) 
    ...
    async function handleVideo(video, message, voiceChannel, playlist = false) {
        ...
        if (!serverQueue) {
          ...
          try {
            ...
            return message.channel.send(`:red_square:  **| Ses kanalına giremedim HATA: ${error}**`);
          }
        } else {
          ...
          .setColor("RANDOM")
          .setDescription(`[${song.title}](https://www.youtube.com/watch?v=${song.id}) adlı şarkı kuyrukta!`)
        ...
        .addField("**Parçayı Seçen:**", `${song.requester}`, true)
